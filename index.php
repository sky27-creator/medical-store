...
<div class="dashboard" style="position: fixed;width: 18%;height: 100%;background:#222D32">
  ...
  <div>
    <div style="background:#1E282C;color: white;padding: 13px 17px;border-left: 3px solid 	#0040ff;"><span><i class="fa fa-dashboard fa-fw"></i> Dashboard</span></div>
    <div class="item">
...
<!--         <a href="newsell"><li><i class="fa fa-circle-o fa-fw"></i> New Sell</li></a> -->
  ...
  <div style="background:#1E282C;color: white;padding: 13px 17px;border-left: 3px solid 	#0040ff;"><span><i class="fa fa-globe fa-fw"></i> Other Menu</span></div>
  <div class="item">
      <ul class="nostyle zero">
...
<div class="marginLeft" >
  <div style="color:white;background: 	#4BEDDC" >
...
<div class="account" style="display: none;">
  <div style="background: 	#0040ff;padding: 22px;" class="center">
  ...
  ?>
    <a href="inventeries.php?catId=<?php echo $row['id'] ?>"><div class="box2 col-md-3">
     <div class="center"> <img src="photo/<?php echo $row['pic'] ?>" style="width: 155px;height: 122px;" class='img-thumbnail'></div>
      ...
      <hr style="margin: 7px;">
      <span style="padding: 11px"><strong style="font-size: 10pt">Available Qty</strong><span class="pull-right" style="color:#191818f7;margin-right: 11px"><?php echo $row2['count(*)']; ?></span></span>
    </div></a>
  <?php
    }
   ?>
